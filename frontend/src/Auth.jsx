      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 lg:p-12 relative">
        ...
        <div className="w-full max-w-[440px] z-10">
          ...
          <div className="bg-white rounded-[10px] p-10  border border-slate-100 relative overflow-hidden">
            ...
            {error && (
              <div className="mb-6 p-4 bg-red-50 border border-red-100 rounded-[10px] text-red-600 text-[10px] font-black uppercase tracking-widest">
                {error}
              </div>
            )}
            ...
            <button 
              ...
              disabled={loading}
              className="w-full bg-white border border-slate-200 text-slate-700 font-bold text-xs uppercase py-4 rounded-[10px] hover:bg-slate-50 transition-all flex items-center justify-center gap-3 shadow-sm group disabled:opacity-50"
            >
